               ...
               <ul>
                  ...
                  <li className="birth-section">
                     <div className="area-style">
                        ...
                        <p className="help-style"><IoCheckmark />-를 제외한 8글자 ex) 19990314</p>
                     </div>
                  </li>
                  <li>
                     <br />
                  ...
                  <li id="terms-section">
                     ...
                     <p>
                        ...
                        <label htmlFor="term-check2">동의함</label>
                     ...
                     <div className="termsBox">
                        ...
                        <p>ο 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산 콘텐츠 제공 , 구매 및 요금 결제 , 물품배송 또는 청구지 등 발송
                        <br />
                           ο 회원 관리
                           회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인 , 고지사항 전달 ο 마케팅 및 광고에 활용
                           접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계
